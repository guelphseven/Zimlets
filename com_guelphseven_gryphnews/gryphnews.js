function com_guelphseven_gryphnews() {
}
com_guelphseven_gryphnews.prototype = new ZmZimletBase();
com_guelphseven_gryphnews.prototype.constructor = com_guelphseven_gryphnews;

com_guelphseven_gryphnews._feed = "http://feeds.feedburner.com/uoguelph";
...
com_guelphseven_gryphnews.prototype._invoke =
function(postCallback) {
	var feedUrl =  ZmZimletBase.PROXY + AjxStringUtil.urlComponentEncode(com_guelphseven_gryphnews._feed);

	AjxRpc.invoke(null, feedUrl, null, new AjxCallback(this, this._reponseHandler, postCallback), true);
};

com_guelphseven_gryphnews.prototype._reponseHandler =
...
com_guelphseven_gryphnews.prototype._showErrorMsg =
function(msg) {
...
//--------------------------------------
com_guelphseven_gryphnews.prototype.doubleClicked =
function() {	
	this.singleClicked();
};

com_guelphseven_gryphnews.prototype.singleClicked =
function() {	
...
com_guelphseven_gryphnews.prototype.menuItemSelected = function(itemId) {
	switch (itemId) {
...
//		DIALOG VIEW
//--------------------------------------
com_guelphseven_gryphnews.prototype._displayRSSResultsDialog =
function() {
...
com_guelphseven_gryphnews.prototype._constructDialogView =
function() {
	var html = new Array();
	var i = 0;
...
com_guelphseven_gryphnews.prototype._showRSSInMiniCal = function() {
...
com_guelphseven_gryphnews.prototype._showMinicalView =
function() {
...
com_guelphseven_gryphnews.prototype._displayPrefDialog =
function() {
...
com_guelphseven_gryphnews.prototype._createPreferenceView =
function() {
	var html = new Array();
	var i = 0;
	html[i++] = "<DIV>";
...
com_guelphseven_gryphnews.prototype._okBtnListner =
function() {
