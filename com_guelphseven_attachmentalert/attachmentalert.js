 ...
 * Constructor
 */
function com_guelphseven_attachalert_HandlerObject() {
}

com_guelphseven_attachalert_HandlerObject.prototype = new ZmZimletBase();
com_guelphseven_attachalert_HandlerObject.prototype.constructor = com_guelphseven_attachalert_HandlerObject;

/**
 * Simplify Zimlet handler name.
 */
var AttachAlertZimlet = com_guelphseven_attachalert_HandlerObject;
...
function() {
	...
	var dialog_args = {
			title	: "Attachment Alert: Preferences",
			view	: this.pView,
...
function() {
    ...
    html[i++] = "Enable \"Attachment Alert\" Zimlet (requires a browser refresh)";
    html[i++] = "</div>";
    return html.join("");
};
